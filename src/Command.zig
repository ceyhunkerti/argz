...
runner: ?*const fn (self: *Command, ctx: ?*anyopaque) anyerror!i32 = null,
...
pub fn init(allocator: mem.Allocator, name: []const u8, runner: ?*const fn (self: *Command, ctx: ?*anyopaque) anyerror!i32) Command {
    return Command{
        .allocator = allocator,
        .name = name,
        .runner = runner,
...
pub fn run(self: *Command, ctx: ?*anyopaque) anyerror!i32 {
